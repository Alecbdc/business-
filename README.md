...
- **Market bulletin board**: rotating, fictional headlines beneath the sandbox charts/logs that refresh every few hours so learners can practice reading sentiment and mapping it to assets.
