...
- **Fake trading sandbox**: €10k starting balance, random-walk prices, and 60+ tradable assets (BTC, ETH, USDT, XRP, SOL, etc.) with persisted portfolio value plus zoomable 1D → 10Y charts for both the portfolio and each asset — including a personal market subtab with 1×/2×/5×/10× pacing for local experiments alongside the synchronized live feed.
