...
- **Fake trading sandbox**: €10k starting balance, random-walk prices, and 60 tradable **stocks** with persisted portfolio value plus zoomable 1D → 10Y charts for both the portfolio and each name on the synchronized live feed or market scenarios.
- **Market bulletin board**: rotating, fictional stock headlines beneath the sandbox charts/logs that refresh every few hours so learners can practice reading sentiment, mapping it to names, opening full-length briefs with projected impacts, and watching those cues tilt simulated prices the way real-world events have historically moved equities.
...
The sandbox now tracks a 60-name equity basket spanning mega-cap tech, industrials, consumer, and growth names:

`AAPL`, `MSFT`, `AMZN`, `GOOGL`, `META`, `TSLA`, `NVDA`, `BRK.B`, `JPM`, `V`, `MA`, `JNJ`, `PG`, `PEP`, `KO`, `MCD`, `WMT`, `HD`, `COST`, `DIS`, `NFLX`, `ADBE`, `CRM`, `ORCL`, `INTC`, `AMD`, `QCOM`, `CSCO`, `IBM`, `PYPL`, `SBUX`, `NKE`, `BA`, `LMT`, `CAT`, `UPS`, `HON`, `GE`, `TSM`, `SONY`, `SAP`, `TM`, `HMC`, `RIVN`, `GM`, `F`, `UBER`, `ABNB`, `SHOP`, `SQ`, `PLTR`, `SNOW`, `ZM`, `DOCU`, `ETSY`, `SPOT`, `ROKU`, `CRWD`, `DDOG`, `NET`.
