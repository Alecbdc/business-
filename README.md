...
- **Market bulletin board**: rotating, fictional headlines beneath the sandbox charts/logs that refresh every few hours so learners can practice reading sentiment, mapping it to assets, and watching those cues tilt simulated prices the way real-world events have historically moved crypto.
