...
export const marketScenarioLevels = [
  {
    id: 'beginner',
    name: 'Beginner',
    tagline: 'First storms: softer drawdowns, steady tape.',
    scenarios: [
      {
        id: 'slow-squeeze',
        title: 'Gentle Downtrend: The Slow Squeeze',
        teaser: 'Markets glide lower on soft-recession whispers and shrinking liquidity.',
        difficulty: 1,
        durationDays: 45,
        bias: -0.002,
        volatility: 0.05,
        ...
        description:
          'Inspired by pre-recession drifts where indices leak lower for weeks, credit spreads widen slowly, and risk is repriced in small daily nibbles.',
        tips: [
          'Momentum shorts work early, but beware of late-cycle bear market rallies.',
          'Keep cash handy—dips in strong majors can revert quickly.',
          'Avoid oversized alt bets; liquidity thins into every bounce.'
        ],
        news: [
          {
            id: 'slow-gdp',
            title: 'Growth outlook shaved again; soft-landing hopes wobble',
            summary: 'FrothCool Bureau trims GDP outlook while “Bland Bank” hints at caution.',
            drift: -0.06,
          ...
          {
            id: 'earnings-drift',
            title: 'Mega-corps guide lower—risk tone sours',
            summary: 'MegaCapsia revises guidance; traders de-risk alts.',
            drift: -0.08,
            assets: ['ALT_BASKET'],
            atDay: 18
          },
          {
            id: 'relief-rumor',
            title: 'Relief chatter sparks short-covering burst',
            summary: 'Whispers of stimulus 2.0 lift majors while alts lag.',
            drift: 0.05,
            assets: ['BTC', 'ETH'],
            atDay: 32
          }
      ...
      {
        id: 'money-printer-jr',
        title: 'Money Printer Jr.',
        teaser: 'Lite QE vibes with creeping inflation risk.',
        difficulty: 1,
        durationDays: 50,
        bias: 0.003,
        volatility: 0.045,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Echoes of mini-QE phases: liquidity loosens, majors grind up, but taper rumors linger at the edges.',
        tips: [
          'Ride the early bid in BTC/ETH but trail stops once taper rumors appear.',
          'Rotate from meme risk into sturdier majors as returns compound.',
          'Use pullbacks to add—spikes may fade when taper notes hit the wire.'
        ],
        news: [
          {
            id: 'qe-lite',
            title: 'Central bazooka? “Money Printer Jr.” debuts',
            summary: 'Liquidity hose opens; majors catch a bid.',
            drift: 0.12,
            assets: ['BTC', 'ETH', 'SOL'],
            atDay: 6
          },
          {
            id: 'taper-hint',
            title: 'Taper rumors swirl—froth trims back',
            summary: 'Rumored balance-sheet cap triggers risk-off wobble.',
            drift: -0.07,
            assets: ['ALT_BASKET'],
            atDay: 24
          },
          {
            id: 'inflation-tick',
            title: 'Inflation tick spooks carry trades',
            summary: 'Short-duration pumps fade as prints run hot.',
            drift: -0.04,
            assets: ['BTC', 'ETH'],
            atDay: 34
          }
      ...
      {
        id: 'sideways-purgatory',
        title: 'Sideways Purgatory',
        teaser: 'A range-bound tape that punishes overtrading.',
        difficulty: 1,
        durationDays: 40,
        bias: 0.0005,
        volatility: 0.03,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Inspired by weeks of low-vol ranges where breakouts fail and choppy liquidity exhausts impatient traders.',
        tips: [
          'Fade extremes; avoid chasing single green candles.',
          'Small size, wider stops—grindier environments demand patience.',
          'Alts whipsaw harder than majors; keep exposure tighter.'
        ],
        news: [
          {
            id: 'range-note',
            title: 'Macro snooze—vol sellers crowd in',
            summary: 'Implied vol grinds lower; chop intensifies.',
            drift: -0.02,
            assets: ['ALT_BASKET'],
            atDay: 10
          },
          {
            id: 'breakout-fake',
            title: 'False breakout fizzles overnight',
            summary: 'Quick spike reverses; shorts reload.',
            drift: -0.03,
            assets: ['BTC', 'ETH'],
            atDay: 21
          },
          {
            id: 'late-rally',
            title: 'Late squeeze as dealers unwind hedges',
            summary: 'Dealer flows spark end-of-range pop.',
            drift: 0.05,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 33
          }
  ...
  },
  {
    id: 'intermediate',
    name: 'Intermediate',
    tagline: 'Policy whiplash and altseason fever.',
    scenarios: [
      {
        id: 'clampdownistan',
        title: 'Clampdownistan: Ministry of No-Coin',
        teaser: 'Policy crackdowns roll through headlines; majors wobble, alts bleed.',
        difficulty: 2,
        durationDays: 55,
        bias: -0.0035,
        volatility: 0.08,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Mirrors historic China-style clampdowns: sudden bans, liquidity scares, and miner flight stories pressure the tape.',
        tips: [
          'Short-lived bounces—scale out into strength.',
          'Favor sturdier majors; alts stay heavy on every ban rumor.',
          'Hold cash for headline gaps—both up and down.'
        ],
        news: [
          {
            id: 'ban-rumor',
            title: 'Clampdownistan floats fresh exchange bans',
            summary: 'Ministry hints at penalties; miners eye exits.',
            drift: -0.12,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 8
          },
          {
            id: 'miner-exodus',
            title: 'Miner convoys leave “Hashgrad” province',
            summary: 'Hashpower migrates; hash-rate dip triggers volatility.',
            drift: -0.09,
            assets: ['BTC'],
            atDay: 18
          },
          {
            id: 'policy-pause',
            title: 'Officials hint at pause—shorts trim risk',
            summary: 'A modest respite lifts majors for a session.',
            drift: 0.07,
            assets: ['BTC', 'ETH'],
            atDay: 38
          }
      ...
      {
        id: 'new-sheriff',
        title: 'New Sheriff Hates Coins',
        teaser: 'Regulators take the mic; enforcement chills sentiment.',
        difficulty: 2,
        durationDays: 50,
        bias: -0.0025,
        volatility: 0.07,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Echoes of hawkish US leadership: stern pressers, “registration now” speeches, and lawsuit headlines.',
        tips: [
          'Fade relief rallies after enforcement scares.',
          'Rotate into stablecoin pairs or sit in cash when fines drop.',
          'Avoid overexposure to tokens called out in speeches.'
        ],
        news: [
          {
            id: 'speech',
            title: 'New sheriff: “unregistered no more”',
            summary: 'Regulator vows sweeping actions; risk assets skid.',
            drift: -0.11,
            assets: ['ALT_BASKET'],
            atDay: 6
          },
          {
            id: 'lawsuit',
            title: 'Mega exchange probed—liquidity thins',
            summary: 'Withdrawal queues extend; spreads widen.',
            drift: -0.08,
            assets: ['BTC', 'ETH'],
            atDay: 20
          },
          {
            id: 'settlement',
            title: 'Surprise settlement eases pressure',
            summary: 'Risk appetite cautiously returns.',
            drift: 0.09,
            assets: ['BTC', 'ETH', 'SOL'],
            atDay: 36
          }
      ...
      {
        id: 'altseason-fever',
        title: 'Altseason Fever',
        teaser: 'Speculative mania in smaller caps with brutal reversals.',
        difficulty: 2,
        durationDays: 45,
        bias: 0.004,
        volatility: 0.12,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Inspired by classic alt frenzies—parabolic surges, crowded narratives, and equally sharp unwinds.',
        tips: [
          'Trail stops aggressively—moves exhaust quickly.',
          'Scale out into vertical candles; recycle into majors.',
          'Keep some cash; blow-off tops reverse in minutes.'
        ],
        news: [
          {
            id: 'alt-narrative',
            title: '“Chain of Zaps” meme token triples overnight',
            summary: 'Narrative rotation ignites smaller caps.',
            drift: 0.14,
            assets: ['ALT_BASKET'],
            atDay: 5
          },
          {
            id: 'rug-panic',
            title: 'Rug fears hit frothy names',
            summary: 'Liquidity evaporates on rumors; majors bid as refuge.',
            drift: -0.12,
            assets: ['ALT_BASKET', 'BTC', 'ETH'],
            atDay: 19
          },
          {
            id: 'rotation',
            title: 'Rotation into Layer-2s cools meme melt-up',
            summary: 'Capital shifts to sturdier infra plays.',
            drift: 0.05,
            assets: ['ALT_BASKET', 'ETH'],
            atDay: 32
          }
        ]
      }
  ...
  },
  {
    id: 'advanced',
    name: 'Advanced',
    tagline: 'Crisis navigators facing Fed beasts and flash crashes.',
    scenarios: [
      {
        id: 'fedzilla',
        title: 'Fedzilla Awakens',
        teaser: 'Aggressive tightening sends risk assets scrambling.',
        difficulty: 3,
        durationDays: 60,
        bias: -0.004,
        volatility: 0.11,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Mirrors 2022 tightening: jumbo hikes, hawkish pressers, and balance-sheet roll-off shaking leverage trades.',
        tips: [
          'Respect downside momentum; don’t fight consecutive hikes.',
          'Use relief rallies to reduce beta exposure.',
          'Favor relative strength in BTC/ETH over fringe alts.'
        ],
        news: [
          {
            id: 'jumbo-hike',
            title: 'Fedzilla drops jumbo hike—risk sells first',
          ...
          {
            id: 'rolloff',
            title: 'Balance-sheet roll-off accelerates',
            summary: 'QT ramps; duration trades unwind.',
            drift: -0.1,
            assets: ['ALT_BASKET'],
            atDay: 24
          },
          {
            id: 'pause-hint',
            title: 'Pause whispers spark violent squeeze',
            summary: 'Risk soars for a session; fades quickly.',
            drift: 0.11,
            assets: ['BTC', 'ETH'],
            atDay: 42
          }
      ...
      {
        id: 'flash-theatre',
        title: 'Flash Crash Theatre',
        teaser: 'Intraday chaos and micro-liquidity gaps.',
        difficulty: 3,
        durationDays: 40,
        bias: -0.001,
        volatility: 0.16,
        ...
        xpRewards: [100, 200, 300],
        description:
          'A nod to flash-crash days: sudden illiquidity pockets, cascading stops, and rapid mean reversion.',
        tips: [
          'Stay nimble—size down and widen stops.',
          'Hedge with cash into event windows.',
          'Fade extreme wicks after liquidity returns.'
        ],
        news: [
          {
            id: 'down-candle',
            title: 'Exchange glitch triggers candle of doom',
            summary: 'Thin books magnify a single fat finger.',
            drift: -0.2,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 4
          },
          {
            id: 'liquidity-mop',
            title: 'Market makers widen spreads—vol stays hot',
            summary: 'Liquidity shallow; expect more air pockets.',
            drift: -0.08,
            assets: ['ALT_BASKET'],
            atDay: 14
          },
          {
            id: 'snapback',
            title: 'Snapback rally as bids return',
            summary: 'Oversold bounce lifts majors briefly.',
            drift: 0.12,
            assets: ['BTC', 'ETH'],
            atDay: 26
          }
      ...
      {
        id: 'etf-hopeium',
        title: 'ETF Hopeium Run-Up',
        teaser: 'Optimism into approvals with rug-pull risks.',
        difficulty: 3,
        durationDays: 55,
        bias: 0.004,
        volatility: 0.1,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Captures ETF anticipation cycles: steady drift up, sudden rug on delays, then roaring recovery on approval hints.',
        tips: [
          'Scale in on dips; keep powder dry for approval wicks.',
          'Trim into strength—buy the rumor, mind the news.',
          'Alts may lag; beta rides mostly in BTC/ETH.'
        ],
        news: [
          {
            id: 'filing',
            title: 'MegaFund files ETF—market cheers',
            summary: 'Speculative flows push majors higher.',
            drift: 0.12,
            assets: ['BTC', 'ETH'],
            atDay: 9
          },
          {
            id: 'delay',
            title: 'Regulators delay decision—knee-jerk selloff',
            summary: 'Risk trims as approval window extends.',
            drift: -0.1,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 24
          },
          {
            id: 'approval-whisper',
            title: 'Approval whispers spark late melt-up',
            summary: 'Aggressive bid returns ahead of rumored sign-off.',
            drift: 0.15,
            assets: ['BTC', 'ETH'],
            atDay: 40
          }
  ...
  },
  {
    id: 'pro',
    name: 'Pro',
    tagline: 'Survive exchange blow-ups and geopolitical fog.',
    scenarios: [
      {
        id: 'exit-liquidity',
        title: 'Exit Liquidity Exchange',
        teaser: 'An FTX-style unwinding with cascading fear.',
        difficulty: 4,
        durationDays: 60,
        bias: -0.005,
        volatility: 0.15,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Inspired by exchange implosions: solvency rumors, withdrawal halts, and broad contagion to majors.',
        tips: [
          'Cut losers fast—contagion lingers.',
          'Sit in cash during halt headlines; re-enter after stabilization.',
          'BTC/ETH hold better than long-tail alts—rotation matters.'
        ],
        news: [
          {
            id: 'solvency-rumor',
            title: 'Major exchange whispers insolvency—markets flinch',
            summary: 'Spreads widen; users rush exits.',
            drift: -0.18,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 6
          },
          {
            id: 'halt',
            title: 'Withdrawals halted pending audit',
            summary: 'Panic selling across spot and perp books.',
            drift: -0.22,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 18
          },
          {
            id: 'rescue-rumor',
            title: 'White-knight rumors spark relief squeeze',
            summary: 'Partial bounce as rescue whispers spread.',
            drift: 0.14,
            assets: ['BTC', 'ETH'],
            atDay: 34
          }
      ...
      {
        id: 'fog-of-war',
        title: 'Fog of War Markets',
        teaser: 'Geopolitical shocks jolt risk with sudden gaps.',
        difficulty: 4,
        durationDays: 50,
        bias: -0.003,
        volatility: 0.14,
        ...
        xpRewards: [100, 200, 300],
        description:
          'Mirrors conflict-driven tapes: gap-downs, defense pivots, energy swings, and rumor-driven squeezes.',
        tips: [
          'Expect gap risk—size down and avoid overexposure.',
          'Consider defensives within majors; alts are jumpier.',
          'News cadence matters—react, don’t predict.'
        ],
        news: [
          {
            id: 'strike',
            title: 'Border strike shocks markets overnight',
            summary: 'Risk gaps down; safe-haven chatter rises.',
            drift: -0.16,
            assets: ['BTC', 'ETH'],
            atDay: 3
          },
          {
            id: 'ceasefire-talk',
            title: 'Ceasefire whispers boost sentiment',
            summary: 'Relief bids creep back into majors.',
            drift: 0.11,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 17
          },
          {
            id: 'escalation',
            title: 'Renewed clashes; vol spikes again',
            summary: 'Another leg lower as risk-off returns.',
            drift: -0.14,
            assets: ['ALT_BASKET'],
            atDay: 32
          }
      ...
      {
        id: 'dotcom-afterparty',
        title: 'Dot-Com 2.0: Bubble Afterparty',
        teaser: 'Overvalued tech vibes, then a hard de-rating.',
        difficulty: 4,
        durationDays: 65,
        bias: -0.002,
        volatility: 0.13,
        ...
        xpRewards: [100, 200, 300],
        description:
          'A nod to post-bubble hangovers: stretched multiples, soft guidance, and sharp rerates.',
        tips: [
          'Trim euphoria early—gravity returns fast.',
          'Rotate into stronger majors as froth fades.',
          'Alts retrace hardest; avoid catching every dip.'
        ],
        news: [
          {
            id: 'earnings-miss',
            title: 'Mega-tech misses—valuation reset incoming',
            summary: 'Risk reprices overnight; bids thin.',
            drift: -0.13,
            assets: ['ALT_BASKET'],
            atDay: 9
          },
          {
            id: 'guidance-cut',
            title: 'Guidance cuts keep pressure on growth',
            summary: 'Follow-through selling hits beta.',
            drift: -0.1,
            assets: ['BTC', 'ETH', 'ALT_BASKET'],
            atDay: 22
          },
          {
            id: 'value-rotation',
            title: 'Value rotation gives brief crypto lift',
            summary: 'Short squeeze improves mood temporarily.',
            drift: 0.09,
            assets: ['BTC', 'ETH'],
            atDay: 38
          }
